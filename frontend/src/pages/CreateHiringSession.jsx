  ...
  return (
    <motion.div style={styles.page} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.4 }}>
      <div style={styles.container}>
        ...
        <div className="cs-content-wrap" style={styles.contentWrap}>
          <div style={styles.textSection}>
            ...
            <div style={styles.infoCard}>
              <div style={styles.infoIcon}>💡</div>
                <div>
                  <h4 style={styles.infoTitle}>Power Up Your Interviews</h4>
                  <p style={styles.infoText}>Leave the question bank empty to let our AI automatically scan the candidate's resume and generate highly personalized questions on the fly. Select a specific bank only when you need standardized testing across all applicants.</p>
                </div>
              </div>
          </div>
