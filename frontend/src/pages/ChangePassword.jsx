        ...
        <nav style={styles.sideNav}>
          ...
          {isAccountOpen && (
            <div style={styles.nestedMenu}>
              ...
              <Link to="/change-password" style={styles.nestedLinkActive}>Change Password</Link>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.inputGroup}>
              ...
              <input 
                ...
                style={{
                  ...styles.input,
                  borderColor: passwords.confirm && passwords.new !== passwords.confirm ? '#ef4444' : '#d1d5db'
                }} 
...
const styles = {
  ...
  helpText: { fontSize: '11px', color: '#888888', marginTop: '6px', display: 'block', fontWeight: 400 },
  ...
  errorText: { fontSize: '11px', color: '#ef4444', marginTop: '4px', display: 'block', fontWeight: 500 },
