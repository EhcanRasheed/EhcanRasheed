...
const styles = {
  ...
  premiumLinkActive: { textDecoration: 'none', color: '#800000', padding: '12px 16px', borderRadius: '8px', fontSize: '14px', fontWeight: 600, display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#fff5f5', border: '1px solid #fee2e2' },
  ...
  launchCard: { background: '#fff', padding: '60px', borderRadius: '32px', border: '1px solid #e2e8f0', textAlign: 'center', maxWidth: '700px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' },
  launchTitle: { fontSize: '2rem', fontWeight: 800, color: '#0f172a', marginBottom: '16px', marginTop: '12px' },
  launchText: { color: '#64748b', fontSize: '16px', lineHeight: '1.6', marginBottom: '16px' },
  maroonBtn: { background: '#800000', color: '#fff', border: 'none', padding: '14px 32px', borderRadius: '12px', fontWeight: 700, cursor: 'pointer', fontSize: '16px', marginTop: '8px' },
